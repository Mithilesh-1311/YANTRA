...
────────────────────────────
Every 0.015s = 1 simulated minute.
...
SPIKE: appliance event (AC, washing machine, etc.)
  - fires randomly based on time of day (0.1–0.3% chance per minute)
  - lasts 20–90 simulated minutes  (real appliance cycle)
  - drains 0.033–0.083 kWh/min = 2–5 kW  (real appliance range)
"""
